import pandas as pd
from eia_downloads.steo.find_last_update import updatecompiler
from eia_downloads.steo.create_more_files import main as create_more_files
...
class steo:
    def __init__(self):
        self.meta = pd.read_csv(config.get_lookup_path("steo", "metadata_steo.csv"))
    ...
    def get_all(self,offset_months=3):
        ...
        df.to_feather(str(config.get_data_path("steo", "steo_pivot.feather")))
