...
def generate_top_importers_table(padd_filter='US'):
    ...
    return dash_table.DataTable(
        ...
        columns=[
            ...
            {"name": "Sources", "id": "Sources", "type": "numeric", "format": Format(scheme=Scheme.fixed, precision=0)},
            ...
            {"name": "Dependency Index", "id": "Dependency Index", "type": "numeric", "format": Format(scheme=Scheme.fixed, precision=0, group=Group.yes, group_delimiter=',')}
        ],
