...
idents = {
    #Products Supplied
    'WRPUPUS2' : 'Petroleum Products Supplied (kbd)',
    'WGFUPUS2' : 'Finished Motor Gasoline Supplied (kbd)',
    'WDIUPUS2' : 'Distillate Fuel Oil Supplied (kbd)',
    'WKJUPUS2' : 'Kerosene-Type Jet Fuel Supplied (kbd)',
    'WREUPUS2' : 'Residual Fuel Oil Supplied (kbd)',
    'WPRUP_NUS_2' : 'Propane and Propylene Supplied (kbd)',
