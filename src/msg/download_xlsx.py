...
import pandas as pd
import numpy as np
from src.msg.mapping import production_mapping
from src.msg.generate_additional_tickers import generate_additional_tickers
from src.msg.generate_line_data import generate_line_data
from src.msg.generate_seasonality_data import generate_seasonality_data

def download_raw_file():
    url = "https://ir.eia.gov/wpsr/psw09.xls"
    response = requests.get(url)
    file_path = "./data/msg/eia_weekly_psw09.xls"
...
def main():
    try:
        ...
        df.to_feather('./data/msg/wps_gte_2015.feather')
        pv = pivot_data(df)
        pv.reset_index(drop=True,inplace=True)
        pv.to_feather('./data/msg/wps_gte_2015_pivot.feather')
        ...
        import traceback
        traceback.print_exc()
        pv = pd.read_feather('./data/msg/wps_gte_2015_pivot.feather')
